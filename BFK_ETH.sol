...
contract BFK is ERC20, Ownable {
    ...
    constructor() ERC20("BFK WARZONE", "BFK") {
        ...
        buyTeamFee = 1;
        buyStakingFee = 1;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyDevFee + buyTeamFee + buyStakingFee;
        ...
        sellTeamFee = 1;
        sellStakingFee = 1;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellDevFee + sellTeamFee + sellStakingFee;

        operationsAddress = address(0x89503B4c4C24CD5CbB00700D6BbeBE046fE10238);
        devAddress = address(0x89503B4c4C24CD5CbB00700D6BbeBE046fE10238);
        teamAddress = address(0x89503B4c4C24CD5CbB00700D6BbeBE046fE10238);
        stakingAddress = address(0x89503B4c4C24CD5CbB00700D6BbeBE046fE10238);
        futureOwnerAddress = address(0x89503B4c4C24CD5CbB00700D6BbeBE046fE10238);
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _devFee, uint256 _teamFee, uint256 _stakingFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _devFee, uint256 _teamFee, uint256 _stakingFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        if(tokensForTeam > 0 && balanceOf(address(this)) >= tokensForTeam) {
            _transfer(address(this), address(teamAddress), tokensForTeam);
        }
        tokensForTeam = 0;
    ...
    function setStakingAddress(address _stakingAddress) external onlyOwner {
        require(_stakingAddress != address(0), "address cannot be 0");
